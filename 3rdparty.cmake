...
macro(sdl2_github)
    message("SDL2")
    set(FILENAME "SDL2-devel-2.30.7-VC.zip")
    if (NOT EXISTS "${DOWNLOAD_DIR}/${FILENAME}")
        message("  downloading")
        file(DOWNLOAD "https://github.com/libsdl-org/SDL/releases/download/release-2.30.7/${FILENAME}" "${DOWNLOAD_DIR}/${FILENAME}" STATUS downloaded)
    endif()
    if (EXISTS "${CMAKE_INSTALL_PREFIX}/SDL2")
      message("  removing ${CMAKE_INSTALL_PREFIX}/SDL2")
      execute_process(COMMAND ${CMAKE_COMMAND} -E remove_directory "${CMAKE_INSTALL_PREFIX}/SDL2")
    endif()
    message("  extracting")
    execute_process(COMMAND ${CMAKE_COMMAND} -E tar xzf "${DOWNLOAD_DIR}/${FILENAME}" WORKING_DIRECTORY "${CMAKE_INSTALL_PREFIX}")
    message("  renaming")
    file(RENAME "${CMAKE_INSTALL_PREFIX}/SDL2-2.30.7" "${CMAKE_INSTALL_PREFIX}/SDL2")
endmacro()
